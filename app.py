...
def result():
    ...
    if age > 60:
        if meisu[0:2] < '11':
            ...
            yourType = f'{even_odd}のインディアン型{meisu[0:2]}'

        elif meisu[0:2] < '31':
            print(f'あなたは{even_odd}の鳳凰型です。')
            yourType = f'{even_odd}の鳳凰型{meisu[0:2]}'

        elif meisu[0:2] < '41':
            print(f'あなたは{even_odd}の時計型です。')
            yourType = f'{even_odd}の時計型{meisu[0:2]}'

        elif meisu[0:2] < '51':
            print(f'あなたは{even_odd}のカメレオン型です。')
            yourType = f'{even_odd}のカメレオン型{meisu[0:2]}'

        elif meisu[0:2] < '61':
            print(f'あなたは{even_odd}のイルカ型です。')
            yourType = f'{even_odd}のイルカ型{meisu[0:2]}'
        ...
        if meisu[2:4] < '11':
            ...
            print(f'あなたは{even_odd}のインディアン型です。')
            yourType = f'{even_odd}のインディアン型{meisu[2:4]}'

        elif meisu[2:4] < '31':
            print(f'あなたは{even_odd}の鳳凰型です。')
            yourType = f'{even_odd}の鳳凰型{meisu[2:4]}'

        elif meisu[2:4] < '41':
            print(f'あなたは{even_odd}の時計型です。')
            yourType = f'{even_odd}の時計型{meisu[2:4]}'

        elif meisu[2:4] < '51':
            print(f'あなたは{even_odd}のカメレオン型です。')
            yourType = f'{even_odd}のカメレオン型{meisu[2:4]}'

        elif meisu[2:4] < '61':
            print(f'あなたは{even_odd}のイルカ型です。')
            yourType = f'{even_odd}のイルカ型{meisu[2:4]}'
        ...
        if meisu[4:6] < '11':
            ...
            print(f'あなたは{even_odd}のインディアン型です。')
            yourType = f'{even_odd}のインディアン型{meisu[4:6]}'
            ...
            print(f'あなたは{even_odd}の時計型です。')
            yourType = f'{even_odd}の時計型{meisu[4:6]}'

        elif meisu[4:6] < '51':
            print(f'あなたは{even_odd}のカメレオン型です。')
            yourType = f'{even_odd}のカメレオン型{meisu[4:6]}'

        elif meisu[4:6] < '61':
            print(f'あなたは{even_odd}のイルカ型です。')
            yourType = f'{even_odd}のイルカ型{meisu[4:6]}'
